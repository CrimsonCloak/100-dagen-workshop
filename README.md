...
Vervang vervolgens het TODO-commentaar over Google Maps door een ingebedde kaart. Gebruik een generator zoals [map-embed.org](https://www.map-embed.org/) om de embed-code te genereren voor het gewenste adres. Kies voor een responsive kaart!
